...
![Скриншот сайта](https://github.com/Linalleks/online_library/blob/main/screenshots/Screenshot_1.png)
...
Данные о книгах загружаются из JSON-файла: "meta_data.json".
